...
def track_output(final_outputs):
        output_filepath_1 = os.path.join(os.path.dirname(os.path.realpath(__file__)), "samples", "output-final-msg.txt")
        output_filepath_2 = os.path.join(os.path.dirname(os.path.realpath(__file__)), "samples", "output-full-traces.txt")
